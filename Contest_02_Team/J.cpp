...
void solve(){
    set<string> ans; string aux;
    int a, b; cin >> a >> b; vs a1(a), b1(b);
    getline(cin, aux);
    FOR2(i, a)getline(cin, a1[i]);
    FOR2(j, b)getline(cin, b1[j]);
    FOR2(i, a) FOR2(j, b) ans.insert(a1[i] + b1[j]);
    cout << ans.size() << '\n';
}
